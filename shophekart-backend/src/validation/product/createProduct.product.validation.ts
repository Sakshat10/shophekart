...
const createProductSchema = z.object({
    body: z.object({
        productIdOnChain: z
            ...
            .optional(),
        sellerId: z.string({ required_error: validationErrorMessages.MISSING_ENTITY("Seller Id") }),
        ...
        category: z.string({ required_error: validationErrorMessages.MISSING_ENTITY("Category") }),
        email: z
