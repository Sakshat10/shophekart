...
import useBuyCshopToken from "../hooks/useBuyCshopToken";
						...
						<div>
								...
								<div className="flex flex-col gap-2">
									<Show when={isApproveLoading}>
										<p className="text-gray-500">
											Please approve the transaction for usdt transfer in metamask
										</p>
									</Show>
									<Show when={!isApproveLoading && isBuyTokenLoading}>
										<p className="text-gray-500">
											Please confirm the transaction for buying cshop token in metamask
										</p>
									</Show>
									<Show
										when={
											!isApproveLoading && !isBuyTokenLoading && !isSuccess && isPending
										}
									>
										<p className="text-gray-500">
							...
							<Show when={!isPending && !isSuccess}>
								<p className="text-sm text-gray-500">
									Please confirm to complete your purchase. Your tokens will be added to
									your wallet shortly after the transaction is finalized!
								</p>
							</Show>
						</div>
						<Show when={!isSuccess}>
