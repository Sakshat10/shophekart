			...
			>
				{menuOpen && (
					<>
						...
						<div className="flex flex-col">
							...
							{isStakingOpen && (
								<div className="flex flex-col space-y-2 mt-2">
									<Link
										to="https://www.shophekart.com/staking"
										onClick={handleLinkClick}
									...
									<Link
										to="https://www.shophekart.com/dao"
										onClick={handleLinkClick}
										className="text-black hover:bg-blue-500 hover:text-white py-2 px-4 rounded"
									>
										DAO
						...
						<div className="flex flex-col">
							...
							{isPlatformOpen && (
								<div className="flex flex-col gap-2 space-y-2 mt-2">
									<Link
										to="https://www.shophekart.com/products/buy-now"
										onClick={handleLinkClick}
										className="text-black hover:bg-blue-500 hover:text-white py-2 px-4 rounded"
									>
										Crypto Shop
									...
									<Link
										to="https://www.shophekart.com/tokenization"
										onClick={handleLinkClick}
										className="text-black hover:bg-blue-500 hover:text-white py-2 px-4 rounded"
									>
										Tokenization
						...
						<Link
							to="https://www.shophekart.com/cshopCard"
							onClick={handleLinkClick}
							className="flex items-center space-x-2 text-black hover:bg-blue-500 hover:text-white py-2 px-4 rounded"
						>
							<FaFileAlt />
						...
						<Link
							to="https://shophekart.gitbook.io/shophekart"
							target="_blank"
							onClick={handleLinkClick}
							className="flex items-center space-x-2 text-black hover:bg-blue-500 hover:text-white py-2 px-4 rounded"
						>
