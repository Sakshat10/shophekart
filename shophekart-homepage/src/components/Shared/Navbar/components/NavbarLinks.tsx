	...
	return (
		<div className="flex space-x-8  items-center justify-center">
			...
			>
				...
				>
					<NavLink
						href="https://www.shophekart.com/staking"
          ...
          >
            Vesting
					...
					<NavLink
						href="https://www.shophekart.com/dao"
						className="block px-4 py-2 text-gray-800 hover:bg-blue-500 hover:text-white"
					>
						DAO
					</NavLink>
			...
			>
				...
				>
					<NavLink
						href="https://www.shophekart.com/products/buy-now"
						className="block px-4 py-2 text-gray-800 hover:bg-blue-500 hover:text-white"
					>
						Crypto Shop
					</NavLink>
					<NavLink
						href="https://www.shophekart.com/tokenization"
						className="block px-4 py-2 text-gray-800 hover:bg-blue-500 hover:text-white"
					>
						Tokenization
					</NavLink>
			...
			<NavLink href="https://www.shophekart.com/cshopCard">CSHOP Card</NavLink>
			<NavLink
				target="_blank"
